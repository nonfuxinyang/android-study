package com.czzdit.commons.utils;
...
public class UtilTypeface {
    ...
    public static void replaceFont(@NonNull View root, String fontPath) {
        ...
        } else if (root instanceof ViewGroup) { // If view is ViewGroup, apply this method on
            // it's child views
...
//    </style>
    public static void replaceSystemDefaultFont(@NonNull Context context, @NonNull String
            fontPath) {
